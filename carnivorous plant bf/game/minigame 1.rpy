init python:
    ...
    class Appearing(renpy.Displayable):
        ...
        def __init__(self, child, xpos, ypos, **kwargs):
        ...
        def event(self, ev, x, y, st):
            ...
            if renpy.map_event(ev,"anyrepeat_K_LEFT"):
                self.xpos = self.xpos + 100
                # self.alpha = 1
                renpy.redraw(self,0)


            elif renpy.map_event(ev,"anyrepeat_K_RIGHT"):
                self.xpos = self.xpos - 100
                # self.alpha = 0
                renpy.redraw(self,0)
...
screen alpha_magic:
    add Appearing("images.jpg", 500, 500):
        pos(100,100)
