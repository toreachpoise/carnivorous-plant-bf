...
label chapter3:
	...
	"Your [boyfriend]'s leaves remain furled. {fast}"
	if boyfriend == "flytrap":
		"The heads no longer seem to be dancing and are kind of downcast."
	if boyfriend == "spider":
		"Most of its eyes are closed or look drowsily off at the walls."
	if boyfriend == "foxglove":
		"The lips on each of their blossoms aren't as shiny anymore, they're dull and chapped looking now."
	if boyfriend == "thistle":
		"The thorns are still as sharp but the big eyestalk is drooping somewhat."
	if boyfriend == "orb":
		"The fleshly leaves look a little pruney, and you could swear the orb is a little smaller."
	...
	menu:
		...
		"Take a look":
			...
			p "Hopefully the second page was just a translation or something and nothing important."
			jump plantsetup
		"Nah":
			$ optimism += 1
